              ...
              <div className="grid gap-12 sm:grid-cols-2 sm:gap-x-6 md:gap-y-8 items-start">
                ...
                <article className="flex flex-col h-full">
                  <header>
                    <Link className="block mb-4" to="/blog-post">
                      <figure className="relative h-0 pb-9/16">
                        <img className="absolute inset-0 w-full h-full object-cover" src={require('../images/news-01.jpg')} width="352" height="198" alt="News 01" />
                      </figure>
                    </Link>
                  ...
                  <footer className="flex items-center mt-4">
                    <a href="#0">
                      <img className="rounded-full flex-shrink-0 mr-3" src={require('../images/news-author-03.jpg')} width="32" height="32" alt="Author 03" />
                    </a>
                ...
                <article className="flex flex-col h-full">
                  <header>
                    <Link className="block mb-4" to="/blog-post">
                      <figure className="relative h-0 pb-9/16">
                        <img className="absolute inset-0 w-full h-full object-cover" src={require('../images/news-02.jpg')} width="352" height="198" alt="News 02" />
                      </figure>
                    </Link>
                    <Link className="hover:underline" to="/blog-post">
                      <h3 className="h4 font-red-hat-display mb-2">
                  ...
                  <footer className="flex items-center mt-4">
                    <a href="#0">
                      <img className="rounded-full flex-shrink-0 mr-3" src={require('../images/news-author-06.jpg')} width="32" height="32" alt="Author 06" />
                    </a>
                    <div className="text-sm text-gray-500">
                ...
                <article className="flex flex-col h-full">
                  <header>
                    <Link className="block mb-4" to="/blog-post">
                      <figure className="relative h-0 pb-9/16">
                        <img className="absolute inset-0 w-full h-full object-cover" src={require('../images/news-03.jpg')} width="352" height="198" alt="News 03" />
                      </figure>
                    </Link>
                    <Link className="hover:underline" to="/blog-post">
                      <h3 className="h4 font-red-hat-display mb-2">
                  ...
                  <footer className="flex items-center mt-4">
                    <a href="#0">
                      <img className="rounded-full flex-shrink-0 mr-3" src={require('../images/news-author-01.jpg')} width="32" height="32" alt="Author 01" />
                    </a>
                    <div className="text-sm text-gray-500">
                ...
                <article className="flex flex-col h-full">
                  <header>
                    <Link className="block mb-4" to="/blog-post">
                      <figure className="relative h-0 pb-9/16">
                        <img className="absolute inset-0 w-full h-full object-cover" src={require('../images/news-04.jpg')} width="352" height="198" alt="News 04" />
                      </figure>
                    </Link>
                    <Link className="hover:underline" to="/blog-post">
                      <h3 className="h4 font-red-hat-display mb-2">
                ...
                <article className="flex flex-col h-full">
                  <header>
                    <Link className="block mb-4" to="/blog-post">
                      <figure className="relative h-0 pb-9/16">
                        <img className="absolute inset-0 w-full h-full object-cover" src={require('../images/news-05.jpg')} width="352" height="198" alt="News 05" />
                      </figure>
                    </Link>
                    <Link className="hover:underline" to="/blog-post">
                      <h3 className="h4 font-red-hat-display mb-2">
                  ...
                  <footer className="flex items-center mt-4">
                    <a href="#0">
                      <img className="rounded-full flex-shrink-0 mr-3" src={require('../images/news-author-04.jpg')} width="32" height="32" alt="Author 04" />
                    </a>
                    <div className="text-sm text-gray-500">
                ...
                <article className="flex flex-col h-full">
                  <header>
                    <Link className="block mb-4" to="/blog-post">
                      <figure className="relative h-0 pb-9/16">
                        <img className="absolute inset-0 w-full h-full object-cover" src={require('../images/news-06.jpg')} width="352" height="198" alt="News 06" />
                      </figure>
                    </Link>
                    <Link className="hover:underline" to="/blog-post">
                      <h3 className="h4 font-red-hat-display mb-2">
                  ...
                  <footer className="flex items-center mt-4">
                    <a href="#0">
                      <img className="rounded-full flex-shrink-0 mr-3" src={require('../images/news-author-05.jpg')} width="32" height="32" alt="Author 05" />
                    </a>
                    <div className="text-sm text-gray-500">
